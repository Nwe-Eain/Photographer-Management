 ...
 <?php
             ...
             <form class="form" action="" method="post" id="editForm" enctype="multipart/form-data">
                             <div class="form-group" >            
                                ...
                                <div class="row">
                                <div class="col-md-2">
                                <label for="photographer_name"><h6>Profile</h6></label>
                                </div>  
                                <div class="col-md-5">
                                <input type="file" class="form-control" name="pimg" id="pimg" required="required">
                                </div>
                                </div><br/>
                                ...
                                <div class="col-md-5">
                                 <input type="text" class="form-control" name="phone" id="phone" placeholder="enter phone" title="Enter your phone number if any." required="required">
                                        ...
                                        <div class="col-md-5">
                                         <select type="location" class="form-control" name="location" id="location" required="required">
                                         <?php
                                        ...
                                        <div class="row">
                                         <div class="col-md-2">
                                         <label for="email"><h6>Experience</h6></label>
                                         </div>  
                                        <div class="col-md-5">
                                         <input type="text" class="form-control" id="exp" placeholder="Your Experience" title="Enter your Experience." required="required" name="exp">
                                         </div>
                                        </div><br/>

                                         <div class="row">
                                         <div class="col-md-2">
                                         <label for="email"><h6>Description</h6></label>
                                         </div>  
                                        <div class="col-md-5">
                                        <textarea class="form-control" title="Enter your Description." name="des"></textarea>
                                    </div>
                                        </div><br/>
